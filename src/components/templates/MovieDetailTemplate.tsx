  ...
  return (
    <div>
      <div className="relative movieDetail">
        <div
          className="bg-[url(https://cdn.sforum.vn/sforum/wp-content/uploads/2022/03/3575769.webp)] bg-no-repeat bg-cover absolute top-0 left-0 w-full h-full movieDetail_bg"
          style={{
                  ...
                  <div className="mb-10" key={v?.maPhim}>
                    ...
                    >
                      <Card.Meta
                        ...
                        title={v?.tenPhim}
                        description={`${v?.moTa.substring(0, 50)}...`}
                      />
                      <button
                        className="text-center border border-gray-400 p-1 cursor-pointer hover:border-black transition shadow-xl rounded-10 !text-gray-600"
                        onClick={() => {
