...
export const ShowTimesTemplate = () => {
  ...
  const { showTimesList } = useSelector((state: RootState) => state.quanLyRap);
                      ...
                      return (
                        ...
                        >
                          <div className="font-bold">
                            {x.ngayChieuGioChieu.slice(0, 10)}
                          </div>
                          <div>{x.ngayChieuGioChieu.slice(11)}</div>
                        </Link>
                      );
                    })}
                  </div>
  ...
  return (
    <div className="p-20 ShowTimes">
      {showTimesList ? <Tabs tabPosition="top" items={returnLogo()} /> : ""}
    </div>
  );
};
